    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "EZPromptsNode") {
            ...
            nodeType.prototype.onNodeCreated = function() {
                ...
                this.dynamicWidgets = new Map();  // Changed to Map for easier management
            ...
            nodeType.prototype.createParameterWidget = function(param) {
                const { name, type, label, defaultValue, options = {} } = param;
                
                console.log("Creating parameter widget:", name, type);
